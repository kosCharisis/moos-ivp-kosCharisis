...
#----------------------------------------------------------
echo "Launching $COMMUNITY1 MOOS Community with WARP:" $TIME_WARP
pAntler $COMMUNITY1.moos --MOOSTimeWarp=$TIME_WARP >& /dev/null &
echo "Launching $COMMUNITY2 MOOS Community with WARP:" $TIME_WARP
pAntler $COMMUNITY2.moos --MOOSTimeWarp=$TIME_WARP >& /dev/null &
echo "Launching $COMMUNITY3 MOOS Community with WARP:" $TIME_WARP
